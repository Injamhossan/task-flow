...
import { signInWithPopup, GoogleAuthProvider, GithubAuthProvider, FacebookAuthProvider, signInWithEmailAndPassword } from "firebase/auth";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex relative overflow-hidden">
      ...
      {/* Left Side - Form */}
      <div className="w-full lg:w-1/2 flex flex-col p-8 md:p-12 relative z-10 justify-between">
        
        <Link href="/" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-colors w-fit">
          <MoveLeft size={20} />
        ...
        <div className="w-full max-w-md mx-auto space-y-10">
          ...
          >
            ...
            <span className="flex-shrink mx-4 text-zinc-500 text-xs font-bold uppercase tracking-widest">Or continue with email</span>
            <div className="flex-grow border-t border-zinc-800"></div>
          </motion.div>
      ...
      <div className="hidden lg:flex w-1/2 bg-zinc-900 relative items-center justify-center overflow-hidden">
         ...
         <div className="relative z-10 p-12 max-w-lg">
             <div className="mb-10 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-widest backdrop-blur-sm">
                ...
                Trusted by 50K+ Workers
             </div>
             <h2 className="text-5xl font-black font-inter tracking-tighter text-white mb-6 leading-[1.1]">
                EARN MORE. <br />
                <span className="text-zinc-500">WORK LESS.</span> <br />
                <span className="text-transparent" style={{ WebkitTextStroke: "1px #bfff00" }}>PLAY HARD.</span>
             </h2>
             <p className="text-zinc-400 text-lg leading-relaxed">
               Join the fastest growing micro-tasking platform. Instant payouts, flexible hours, and a community of high performers.
             </p>
         </div>
         ...
         <motion.div 
           ...
           className="absolute -top-1/4 -right-1/4 w-[600px] h-[600px] border-[100px] border-zinc-800/20 rounded-full blur-3xl pointer-events-none"
         />
         <motion.div 
           animate={{ 
            rotate: [360, 0],
           ...
           className="absolute -bottom-1/4 -left-1/4 w-[500px] h-[500px] border-[50px] border-primary/5 rounded-full blur-2xl pointer-events-none"
         />
      </div>
