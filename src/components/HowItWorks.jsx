...
export default function HowItWorks() {
  return (
    <section className="bg-black py-24 px-4 sm:px-6 lg:px-8 text-white relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-bold font-inter tracking-tighter uppercase leading-[0.9]">
              <div>How It</div>
              <div
          ...
          <motion.p 
            ...
            className="max-w-md text-zinc-400 text-lg font-light leading-relaxed pb-2"
          >
        ...
        >
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div key={index} variants={item} className="relative z-10 flex flex-col group">
                {/* Number Box */}
                <div className="w-32 h-32 bg-[#0a0a0a] border border-zinc-800 flex items-center justify-center mb-8 relative group-hover:border-primary transition-colors duration-300">
                   {/* Line connection cover for individual box if needed, or just let line pass behind */}
                   <span className="text-4xl font-bold text-zinc-700 font-inter group-hover:text-primary transition-colors duration-300">
                    {step.number}
                  </span>
                </div>
